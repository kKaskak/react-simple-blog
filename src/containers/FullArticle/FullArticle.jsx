...
const FullArticle = () => {
    ...
    return (
        <>
            <HelmetFullArticle slug={slug} title={title} desc={desc} keywords={keywords} headerImageLink={headerImageLink} />
            <PageLayout>
                    ...
                    <div className="ct__full-article__featured">
                        ...
                        <div className="ct__full-article__featured-card">
                            ...
                            <div className="ct__full-article__featured-card-components">
                                <h4>{ffTitle}</h4>
                                <p>{ffParagraph}</p>
                                <Link onClick={ScrollTop} className="ct__full-article__featured-card-components-link" to={`/blog/${ffLink}`}>
                                    <button>
                                        Read <FiArrowUpRight className="ct__full-article__featured-card-arrow" />
                                    </button>
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="ct__full-article__featured-card">
                            <div className="ct__full-article__featured-card-components" style={{ textAlign: 'right' }}>
                                <h4>{fsTitle}</h4>
                                <p>{fsParagraph}</p>
                                <Link onClick={ScrollTop} className="ct__full-article__featured-card-components-link" to={`/blog/${fsLink}`}>
                    ...
                    <div className="ct__full-article__footer">
                        ...
                        >
                            <a target="_blank" rel="noreferrer" href={`https://twitter.com/curiosity__blog`}>
                                <img src={xcorp} alt="xcorp" style={{ maxWidth: 58, borderRadius: '1rem' }} />
                            </a>
