...
const BlogPost = () => {
  ...
  useEffect(() => {
    const query =
      '*[_type == "post"] | order(publishedAtExact desc) {..., categories[]->{title}}';
  ...
  return (
    <>
      <div className="ct__blog-categories">
        {[
          ...
          <div
            ...
            className={`ct__blog-categories-item ${
      ...
      <div
        ...
        className={`ct__blog-categories-item-last ${
          isMoreActive ? "active" : ""
        }`}
      >
        {isMoreActive ? <p>Less</p> : <p>More</p>}
        <BsArrowDown className={`arrow ${isMoreActive ? "active" : ""}`} />
      </div>
