        ...
        <PageLayout>
            ...
            <div className="ct__contact">
                ...
                <div className="ct__contact-waves">
                    <a className="ct__contact-waves__twitter-in" href="https://www.twitter.com/curiosity__blog" rel="noreferrer" target="_blank">
                        <img src={xcorp} alt="xcorp" style={{ width: "66px" }} />
                    </a>
                    <a className="ct__contact-waves__twitter-in" target="_blank" rel="noreferrer" href="https://www.facebook.com/curiosity.takeover/">
                ...
                <div className="ct__contact-waves-div">
                    <svg className="ct__contact-waves__svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                        <path
                            fill="#000000"
                            fillOpacity="1"
                    ...
                    <a className="ct__contact-waves__twitter" href="https://www.twitter.com/curiosity__blog" rel="noreferrer" target="_blank">
                        <img alt="xcorp" src={xcorpwhite} style={{ width: "60px" }} />
                    </a>
                    <a className="ct__contact-waves__twitter-2" href="https://www.facebook.com/curiosity.takeover/" rel="noreferrer" target="_blank">
