  ...
  return (
    <>
      {!isLoading && (
        ...
        <motion.div whileHover={hoverFeatured} initial={'hidden'} whileInView={'show'} variants={FeaturedContainer} className={`ct__header-main ${!isLoading ? 'loaded' : ''}`}>
